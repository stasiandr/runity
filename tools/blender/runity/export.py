"""runity for Blender: the exporter (docs/blender.md).

Sends what Blender evaluated — meshes with their modifiers applied, the
object tree, materials, images and the objects' runity properties — to the
...
The stream: b"RUNITYBL", a u32 version, a u32 length and that much JSON,
