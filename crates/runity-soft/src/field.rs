...
impl DistanceFieldLine for runity_core::EntityDesc {
    fn distance_field(&self) -> Option<DistanceField> {
        self.part()
    }
}

impl DistanceFieldLine for runity_core::scene::Override {
    fn distance_field(&self) -> Option<DistanceField> {
        self.part()
    }
}
...
impl runity_core::world::Dress for DistanceFieldDress {
...
mod tests {
    ...
    fn a_field_baked_from_a_box_and_a_mesh_holds_a_ball_off_both() {
        ...
        let ball = runity_geometry::builtin::sphere(0.5, 24, 12);
