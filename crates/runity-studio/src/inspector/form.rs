...
impl Inspector {
    ...
    pub(super) fn swatch(
        ...
        let fill = rgb.map_or(runity_ui::Color::TRANSPARENT, |[r, g, b]| {
            runity_ui::Color::rgba(r, g, b, 255)
        });
        ui.add(
            swatch,
            Style::row()
    ...
    fn values(&self, session: &Session, owner: &Owner) -> Vec<(Option<runity::EntityId>, String)> {
        match owner {
