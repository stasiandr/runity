...
use runity_core::{components, id, player_prefs, save as save_core, world as world_core, EntityId};
#[allow(unused_imports)]
use runity_physics::bodies;
#[cfg(feature = "physics")]
#[allow(unused_imports)]
...
#[allow(unused_imports)]
mod prelude {
    pub use runity_physics::body::{PhysicsLine, PhysicsOverride};
}
