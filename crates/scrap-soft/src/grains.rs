...
impl Default for Grains {
    fn default() -> Self {
        Self { size: Vec3::new(0.4, 0.8, 0.4), grain: 0.06, friction: 0.7, net: scrap_core::netsim::NetMode::Local }
    }
}
...
impl GrainsLine for scrap_core::EntityDesc {
    fn grains(&self) -> Option<Grains> {
        self.part()
    }
}

impl GrainsLine for scrap_core::scene::Override {
    fn grains(&self) -> Option<Grains> {
        self.part()
    }
}
...
impl scrap_core::world::Dress for GrainsDress {
