...
//! The mesh is made from these; the render module draws it (and raises
//! the ground near the camera from [`Terrain::heights`]), and with
//! `collider: Model` the physics module makes what walkers stand on of it.
//!
//! Its material draws it: `shading: Sand` puts the wind's ripples, glints
//! and drifting sand on it, and the ripples leave the slip faces bare, as
//! real ones do.

use glam::{Vec2, Vec3};
use serde::{Deserialize, Serialize};

use crate::mesh_asset::{MeshAsset, Vertex};
