...
//! test run with one worker (`SCRAP_JOBS=1`), and the frames it draws
//! compared bit for bit.

use std::hash::{Hash, Hasher};

const CHILD: &str = "SCRAP_CORES_CHILD";
