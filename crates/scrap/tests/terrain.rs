...
//! `SCRAP_MESH_SHADERS=1` by mesh shaders.

use scrap::glam::{Mat4, Vec3};
use scrap::material::Shading;
use scrap::render::{Camera, Draw, Frame, Sky, SkyMode, TextureHandle};
...
fn the_fine_grid_has_no_cracks_and_stops_at_the_edge() {
    ...
    // Run with SCRAP_MESH_SHADERS set, the same checks hold of the grid
