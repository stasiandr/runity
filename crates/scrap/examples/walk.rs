...
impl Walk {
    fn new(live: LiveScene) -> Self {
        ...
        Self {
            live,
            shader: scrap::render::ShaderFile::new(scrap::render::SHADER_PATH),
            times: scrap::FrameTimes::new(300),
...
impl Game for Walk {
    ...
    fn frame(&mut self, ctx: &mut Context) -> Frame {
        ...
        let fog = scrap::scene_fog(&self.live.scene().fog());
        let camera = Camera {
            position: self.eye,
        ...
        self.ui.text(TextRun::new(
            ...
            12.0,
            18.0,
            scrap::glam::Vec4::new(0.9, 0.9, 0.88, 0.85),
            format!(
        ...
        scrap::build_frame(
            &self.world,
            camera,
            scrap::scene_lighting(&self.live.scene().sun()),
            fog,
        )
    }
