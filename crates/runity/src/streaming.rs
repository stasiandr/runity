...
//! 80.0)` on an entity; the field is [`runity_core::stream::Stream`]).
//!
...
pub struct StreamPart(pub runity_core::stream::Stream);
...
impl crate::world::Dress for StreamDress {
    ...
    fn dress(
        ...
        match line.part::<runity_core::stream::Stream>() {
            Some(stream) => {
...
impl Streamer {
    ...
    pub fn update(
        ...
        let streams: Vec<(hecs::Entity, runity_core::stream::Stream, Vec3)> = world
