...
fn scene(cube: runity::render::MeshHandle, box_at: Vec3, virtual_maps: bool) -> Frame {
...
fn pages_shadow_where_the_cascades_do_and_a_still_scene_draws_none() {
    ...
    assert!(drawn > 0 && drawn <= 3 * runity::vsm::LEVELS as usize && drawn * 2 < kept, "{drawn} of {kept}");
}
