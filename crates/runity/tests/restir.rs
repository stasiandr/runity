...
use runity::render::{Camera, Draw, Frame, Lighting, PointLight, Sky, SkyMode, TextureHandle};
use runity::{builtin, Gpu, Material, OffscreenTarget, Renderer};

const SIZE: u32 = 96;

fn frame(cube: runity::render::MeshHandle, restir: bool) -> Frame {
    ...
    Frame {
        ...
        ray_tracing: runity::ray::RayTracing {
            light_shadows: true,
            restir,
            ..Default::default()
        },
