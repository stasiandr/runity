...
use runity::render::{Camera, FogSettings, Lighting, Sky, SkyMode};
use runity::world::{build_frame, LiveMesh, Surface, WorldTransform};
...
fn a_live_mesh_is_drawn_from_its_data_as_it_changes() {
    ...
    let mut red_in_middle = |world: &runity::hecs::World| {
