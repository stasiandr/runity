...
// `// scrap:textures` line names them; white where it has none.
...
struct SurfaceIn {
    ...
    uv: vec2<f32>,
    time: f32,
    // The material's own eight numbers (`params` in its .scrmat), in the
    // order its shader's `// scrap:params` line names them.
