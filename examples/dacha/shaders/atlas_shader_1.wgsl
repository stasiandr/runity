...
// blink's scene-depth falloff is dropped. One file serves all three
// materials, so the toggles are consts: the defaults match
// M_Atlas_Triplanar_01; M_Atlas_Triplanar_01 1 has ATLAS_UP = true and
// M_Atlas_Triplanar_Blink_01 has ATLAS_BLINK = true.
...
const ATLAS_UP: bool = false;
const ATLAS_BLINK: bool = false;
