...
| Движок | `runity-core` | ECS на поколениях с запросами, событиями и отслеживанием изменений; иерархия трансформов с dirty-флагами; часы мира отдельно от кадра; репликация, авторитетность, предсказание, уровни детализации; время с фиксированным шагом, ввод, главный цикл, headless-прогон и запись кадров |
