...
Lit scene               9.33/9.47/10.03         1.30/2.40/8.85         0.61/0.91/1.20
Triangle                1.50/2.14/10.04         1.25/2.00/9.06         0.23/0.27/0.28
Meshes                  2.49/3.08/10.42         1.42/2.25/8.60         0.45/0.51/0.56
Textures                2.10/2.59/11.21         1.91/2.25/8.77         0.31/0.35/0.47
Depth & blending        1.56/2.39/12.14         1.71/2.31/8.95         0.33/0.44/0.48
World                   1.94/2.74/11.46         1.89/2.25/8.75         0.37/0.45/0.50
Teapots                  1.41/1.52/3.27        0.20/0.30/31.04         0.39/0.44/0.46
```

Каждая сцена печатает ещё две строки: `on device` — это
`GPUEndTime - GPUStartTime`, собственный взгляд железа на кадр, и `read-back` —
во что обходится скачивание офскрин-кадра обратно в `Framebuffer` (стабильные
0.11–0.15 мс, от размера сцены не зависит).
...
же кодом, что и на CPU, и возвращается блитом — отсюда кадр задержки.
