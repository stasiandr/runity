...
| Рендер | `runity-render` | отложенный растеризатор с PBR, IBL, тенями, SSAO, SSR, bloom и оптикой; мип-маппинг, отсечение по пирамиде видимости, debug-виды и текст в кадре, golden-тесты, PNG (запись и чтение) + DEFLATE |
...
вывод звука в систему (CoreAudio/ALSA/WASAPI), загрузка glTF, HiDPI на macOS, сжимающий PNG-энкодер; из симуляции — сглаживание коррекций на клиенте
