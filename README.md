...
отладочные виды, пробел — действие сцены, Backspace — отменить его, Escape —
выход. Headless-PNG бандл не пишет — для них нужен `cargo run` с
`RUNITY_HEADLESS=1`, как выше.
