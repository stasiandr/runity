...
вывод звука в систему (CoreAudio/ALSA/WASAPI), загрузка glTF, иерархия трансформов и отсечение по frustum, HiDPI на
macOS, сжимающий PNG-энкодер; из симуляции — сглаживание коррекций на клиенте
